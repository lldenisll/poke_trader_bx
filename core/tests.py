...
# Os 2 grupos abaixo, além de serem do mesmo cluster, tem uma distância muito pequena entre eles
        ...
        #Pokemons próximos no cluster 10, o menos poderoso de acordo com o algorítmo
        lista1_cluster_10 = ['pidgey','unfezant','pikipek']
        lista2_cluster_10 = ['spearow','staraptor','fletchling']
        ...
        self.assertTrue(verificar_troca(lista1_cluster_10,lista2_cluster_10))

    def test_troca_false(self):
        lista1_cluster_3 = ['mew','moltres','azelf'] 
        lista1_cluster_10 = ['pidgey','unfezant','pikipek']
        lista2_cluster_10 = ['spearow','staraptor','fletchling']
        # Agora estamos testando pokemons opostos, uma troca entre pokemons do cluster 3 com o cluster 10 não pode ser justa
        self.assertFalse(verificar_troca(lista1_cluster_3,lista1_cluster_10))
        self.assertFalse(verificar_troca(lista1_cluster_3,lista2_cluster_10))
